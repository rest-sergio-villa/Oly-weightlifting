...
- **Infected shin wound — treated, resolving.** Cut the shin on a box around 31 Aug.
  ...
  **Sun 13 Sep: swelled again after box jump overs in the 9am class** (cut to 8 a
  ...
  On **flucloxacillin (oral) + Fucidin (fusidic acid ointment)** from Wed 9 Sep; pills run
  through **Tue 15 Sep**. Sun 13 evening: redness still inside the line drawn that morning.
  **Tell Seb** — it explains the missed Day 2 and now constrains class scaling.
